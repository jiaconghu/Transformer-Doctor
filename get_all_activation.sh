...
export model_path=${result_path}'/train_models/pth/'${data_name}'/tvit_'${data_name}'_base.pth'
export data_dir=${result_path}'/'${exp_name}'/low_images/'${model_name}'/'${data_name}
export save_dir=${result_path}'/tmp/garbage'
python doctor/get_all_activation.py \
